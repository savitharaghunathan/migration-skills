...
|-------|----------|----------------|------|
| [Spring Boot 2 to 3](skills/java/spring-boot-2-to-3/) | Java | Spring Boot 2.7 → 3.0 | [SKILL.md](skills/java/spring-boot-2-to-3/SKILL.md) |
| [Spring Boot 3 to 4](skills/java/spring-boot-3-to-4/) | Java | Spring Boot 3.5 → 4.0 | [SKILL.md](skills/java/spring-boot-3-to-4/SKILL.md) |
| [Spring Boot to Quarkus](skills/java/spring-boot-to-quarkus/) | Java | Spring Boot 3.x → Quarkus 3.x | [SKILL.md](skills/java/spring-boot-to-quarkus/SKILL.md) |
| [JDK 21 to 25](skills/java/jdk-21-to-25/) | Java | JDK 21 → JDK 25 | [SKILL.md](skills/java/jdk-21-to-25/SKILL.md) |
| [Spring Framework 5 to 6](skills/java/spring-framework-5-to-6/) | Java | Spring Framework 5.x → 6.x | [SKILL.md](skills/java/spring-framework-5-to-6/SKILL.md) |
| [Spring Framework 4 to 5](skills/java/spring-framework-4-to-5/) | Java | Spring Framework 4.x → 5.x | [SKILL.md](skills/java/spring-framework-4-to-5/SKILL.md) |
| [Java EE to Jakarta EE](skills/java/javax-to-jakarta-ee/) | Java | Java EE 8 (javax) → Jakarta EE 10 (jakarta) | [SKILL.md](skills/java/javax-to-jakarta-ee/SKILL.md) |
| [JBoss EAP 7 to 8](skills/java/jboss-eap-7-to-8/) | Java | JBoss EAP 7.x → 8.0 | [SKILL.md](skills/java/jboss-eap-7-to-8/SKILL.md) |
| [Hibernate 5 to 6](skills/java/hibernate-5-to-6/) | Java | Hibernate ORM 5.x → 6.x | [SKILL.md](skills/java/hibernate-5-to-6/SKILL.md) |
| [HttpClient 4 to 5](skills/java/httpclient-4-to-5/) | Java | Apache HttpClient 4.x → 5.x | [SKILL.md](skills/java/httpclient-4-to-5/SKILL.md) |
| [Camel 3 to 4](skills/java/camel-3-to-4/) | Java | Apache Camel 3.x → 4.0 | [SKILL.md](skills/java/camel-3-to-4/SKILL.md) |
| [OpenTracing to OpenTelemetry](skills/java/opentracing-to-opentelemetry/) | Java | OpenTracing → OpenTelemetry | [SKILL.md](skills/java/opentracing-to-opentelemetry/SKILL.md) |
| [Java EE to Quarkus](skills/java/javaee-to-quarkus/) | Java | Java EE 7/8 → Quarkus 3 | [SKILL.md](skills/java/javaee-to-quarkus/SKILL.md) |
| [Agent Sandbox v1alpha1 to v1beta1](skills/kubernetes/agent-sandbox-v1alpha1-to-v1beta1/) | Kubernetes | Agent Sandbox CRD v1alpha1 → v1beta1 | [SKILL.md](skills/kubernetes/agent-sandbox-v1alpha1-to-v1beta1/SKILL.md) |
| [FIPS 140 & PQC Compliance](skills/go/fips-pqc-compliance/) | Go | Non-FIPS crypto → FIPS 140-3 compliant + PQC-ready | [SKILL.md](skills/go/fips-pqc-compliance/SKILL.md) |
...
- `skills/` — Generated output, organized by language
  - `java/`
    ...
    - [`javaee-to-quarkus/`](skills/java/javaee-to-quarkus/) — Java EE 7/8 to Quarkus 3 migration (EJB→CDI managed beans, JMS/MDB→SmallRye Reactive Messaging, WAR→JAR packaging, persistence.xml→application.properties, JNDI→injection, app server lifecycle→Quarkus events, WebLogic/JBoss/WildFly decommission, 6 phases)
  - `go/`
